using System; using System.Collections.Generic; using System.Text; using Rave.Models.Tokens; using Newtonsoft.Json;  namespace Rave.Models.MobileMoney {     public class MobileMoneyParams : ParamsBase     {          public MobileMoneyParams(string PbfPubKey, string secretKey, string firstName, string lastName, string email, decimal amount, string currency, string phonenumber, string network, string country, string paymentType, string txRef) : base(PbfPubKey, secretKey, firstName, lastName, email, currency, country)         {             Amount = amount;             Email = email;             Phonenumber = phonenumber;             Network = network;

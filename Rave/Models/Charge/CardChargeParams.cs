...
{
    class CardCharge : ParamsBase
    {
        public CardCharge(string pbfPubKey, string firstName, string lastName, string email, decimal amount) : base(pbfPubKey, firstName, lastName, email)
        {
            Amount = amount;
        }

        public CardCharge(string pbfPubKey, string firstName, string lastName, string email, decimal amount, Card card) : base(pbfPubKey, firstName, lastName, email)
        {
            Amount = amount;
